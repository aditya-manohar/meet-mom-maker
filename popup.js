document.addEventListener('DOMContentLoaded', () => {
    ...
    generateBtn.addEventListener('click', async () => {
        ...
        const participants = participantsOutput.textContent;
        ...
        const prompt = `Generate a professional Minutes of Meeting in markdown format based on the following Meet captions and participants. Include sections for Date, Participants, and Discussion Points. Use today's date. Ensure the tone is formal and concise.
